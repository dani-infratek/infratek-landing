...
export default function Home() {
  ...
  // Load GetWaitlist script
  useEffect(() => {
    if (document.getElementById("getWaitlistScript")) return;
  ...
  return (
    <main className="min-h-screen">
      ...
      <a
        href="https://wa.me/17879481930?text=Hi%20Sergio%2C%20I%27m%20interested%20in%20INFRATEK.AI"
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#1da851] text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 group"
